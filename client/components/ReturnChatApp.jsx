...
class ChatApp extends React.Component {
    ...
    handleSendClick() {
        ...
        if (counter == 1) {
          ...
          reply = 'Sure , we can help you with that. DO you wish to do an exchange for order # 778098'
          this.textToSpeech(reply);
          var tempMessages = this.state.messages;
          var tempBotMessage = {
              sender: 'Bot',
          ...
          reply = 'I can give you two options-Exchange it from the nearest store or generate label online?'
          this.textToSpeech(reply);
          var tempMessages = this.state.messages;
          var tempBotMessage = {
              sender: 'Bot',
          ...
          reply = 'Sure. System has been updated with the pickup date and return label is also generated.'
          this.textToSpeech(reply);
          var tempMessages = this.state.messages;
          var tempBotMessage = {
              sender: 'Bot',
    ...
    speechToText(e) {
        ...
        recognition.onresult = function (event) {
            ...
            if(questionCounter == 1){
              ...
              speechResult = 'I would use the second option as I can do it immediately from the app.'
            }
            else if(questionCounter == 5){
              speechResult = 'Get it picked next weekend From my house around 13:00PM'
            }
              ...
              <Modal.Content>
                <Grid>
                  <Grid.Row>
                    <Grid.Column width={1}/>
                    <Grid.Column width={14}>
                      <Header style={{color:'white'}}><center>Thanks Your Return Request has been updated successfully!!!</center></Header>
                    </Grid.Column>
                    <Grid.Column width={1}/>
                  </Grid.Row>
                </Grid>
