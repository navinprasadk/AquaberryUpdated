    ...
    return (
      <div style={{ overflow: "hidden" }}>
        <Grid>
          <Grid.Row only="mobile">
            <Grid.Column width={16}>
              <Menu
                secondary
                style={{ backgroundColor: "#f8f8f8", color: "#212121" }}
              >
                <Menu.Item style={{ color: "#212121" }}>
                  <Icon name="close" />
                </Menu.Item>
                <Menu.Item
                  header
        ...
        <Modal
          ...
          dimmer="blurring"
          basic
          open={this.state.downloadStatusModal}
        >
        ...
        >
          ...
          <MenuItem>
            <Header
              ...
              style={{ letterSpacing: "2px", textTransform: "capitalize" }}
            >
              <Icon size="small" name="home" style={{ color: "#212121" }} />My
              Account
            </Header>
          </MenuItem>
