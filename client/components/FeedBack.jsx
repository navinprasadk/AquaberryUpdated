    ...
    return (
      <div>
        ...
        <Grid>
          ...
          >
            <Grid.Column width={5} />
            <Grid.Column width={6}>Feedback</Grid.Column>
            <Grid.Column width={5} />
          </Grid.Row>
          ...
          <Grid.Row style={{ fontSize: "16px", fontFamily: "Raleway" }}>
            <Grid.Column width={1} />
            <Grid.Column width={14} style={{ fontFamily: "Raleway" }}>
              2) How satisfied were you with the product?<br />
              <Radio
                style={{ fontFamily: "Raleway" }}
                label="Very Satisfied"
                value1="Very Satisfied"
          ...
          <Grid.Row style={{ fontSize: "16px", fontFamily: "Raleway" }}>
            <Grid.Column width={1} />
            <Grid.Column width={14} style={{ fontFamily: "Raleway" }}>
              3) Rate the last delivery experience?<br />
              <br />
          ...
          <Grid.Row style={{ fontSize: "16px", fontFamily: "Raleway" }}>
            <Grid.Column width={1} />
            <Grid.Column width={14} style={{ fontFamily: "Raleway" }}>
              5) How Likely you will recommend our brand to your friends and
              colleagues?<br />
              <Radio
                style={{ fontFamily: "Raleway" }}
                label="Very Likely"
          ...
          <Grid>
            ...
            <Grid.Row style={{ fontSize: "16px", fontFamily: "Raleway" }}>
              <Grid.Column width={1} />
              <Grid.Column width={14} style={{ fontFamily: "Raleway" }}>
                8) As a part of our loyalty reward program, we would like to
                invite you to the launch of our new fast fashion range on {this.state.dateValue}
                <br />
                <br />
                Pls confirm your presence by clicking <br />
                <br />
                <Radio
                  style={{ fontFamily: "Raleway" }}
                  label="Attending"
          ...
          <Grid.Row>
            ...
            <Grid.Column width={4}>
              <Button
                positive
                onClick={this.hadlesubmit.bind(this)}
              ...
              <Grid.Row>
                ...
                <Grid.Column width={14} style={{ fontFamily: "Raleway" }}>
                  <Header style={{ color: "white", fontFamily: "Raleway" }}>
                    <center>Thanks for your valuable feedback.</center>
                  </Header>
                </Grid.Column>
                <Grid.Column width={1} />
              </Grid.Row>
