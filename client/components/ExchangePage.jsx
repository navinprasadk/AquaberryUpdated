          ...
          >
            ...
            >
              ...
              <p style={{ marginLeft: "3%", fontFamily: "Raleway" }}>
                <Header className="darkText" style={{ wordSpacing: "17px" }}>
                  {" "}
                  Polka Dot Top
                </Header>
                <p
                ...
                >
                  <span>
                    <Header style={{ fontFamily: "Raleway" }}>$55</Header>
                  </span>{" "}
                  <span>
              ...
              <Link to="/exchangeSuccessful">
                <Segment>
                  <Form>
                    ...
                    >
                      <Radio
                        label="Voice enabled chat bot"
                        name="radioGroup"
                        value="Voice enabled chat bot"
                        checked={this.state.value === "Voice enabled chat bot"}
              ...
              <Link to="/exchangeSuccessful">
                <Segment>
                  <Form>
                    ...
                    >
                      <Radio
                        label="Call CSC through mobile"
                        name="radioGroup"
                        value="Call CSC through mobile"
                        checked={this.state.value === "Call CSC through mobile"}
                        onChange={this.handleChange}
                      />
                    </Form.Field>
                  </Form>
                ...
                <Form>
                  ...
                  >
                    <Radio
                      ...
                      checked={this.state.value === "Sending an Email"}
                      onChange={this.handleChange}
                    />
                  </Form.Field>
                </Form>
