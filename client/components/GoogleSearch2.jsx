...
import { Grid, Input, Card,  Image, Divider, Header, Icon, Dimmer, Loader, Segment } from 'semantic-ui-react';
...
export default class GoogleSearch extends Component{
  ...
  handleUserInput() {
    let input = " want to buy trendy workwear";
    ...
    {
      this.setState({
        adminInputData: this.state.adminInputDataArray[Math.floor(Math.random()*this.state.adminInputDataArray.length)],
      ...
      var temp,settings = {
       ...
       temp = (
         <Grid.Column width = {16} >
           <Slider {...settings} className="cardResult" style={{
                bottom: '3%'
              }}>
                <div style={{
                    padding: '1rem',
                    ...
                    <Card style={{
                      ...
                      <Card.Content>
                        ...
                        <p id="googleSearchDescription" style={{
                          ...
                          Look the biz in this season's slickest workwear at aquaberry, from ladylike shift dresses to super-mart tailoring.
                          {/* Shop for women's tops. Available in a fabulous range from long tops to crop tops. Top For Daily wear */}
                        </p>
                      </Card.Content>
                    </Card>
                  </Card.Group>
                    ...
                    <Card style={{
                      ...
                      <Card.Content>
                        ...
                        <p id="googleSearchDescription" style={{
                          ...
                          Free priority shipping · New arrivals daily · Customer Service Focused · Quick & Secure Checkout , you can order office wear online</p>
                      </Card.Content>
                    </Card>
                  </Card.Group>
                </div>
                      ...
                      <Card.Content>
                        <Link to="/womenCategory">
                          <Card.Header id="googleSearchHeader" style={{
                            ...
                            women's workwear | ladies smart clothing & workwear | Terra
                        ...
                        <p id="googleSearchDescription" style={{
                          ...
                          Explore women's workwear at Terra. Look stylish in the office with sharply cut suits, smart work dresses and tailored jackets & blazers. Shop now
    ...
    handleLabelResults()
      {
        var temp1,settings1 = {
         ...
         temp1 = (
           <Grid.Column width = {16} >
             <Slider {...settings1} className="labelResult" style={{
                  bottom: '0%',
                  marginTop:'-3%'
                }}>
                  <div style={{
  ...
  <Card style={{
    ...
    <Card.Content>
      ...
      <Grid.Row only='mobile' style={{
        ...
        {
          this.state.labelResultStatus
            ? this.state.labelResults
            : null
        }
      </Grid.Row>
      <Grid.Row only='mobile' style={{ position: 'fixed', bottom:'0%',marginTop: '5%', borderTop:'1px grey solid', padding: '0% 0% 0% 2%'}} >
        ...
        <Grid.Column width={14} style={{ textAlign: 'center' }}>
          <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Google_mic.svg/2000px-Google_mic.svg.png" size="tiny"
